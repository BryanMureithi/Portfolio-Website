<template>
    <div>
        <section class="bg-[#E0E1DD] dark:bg-gray-900 antialiased">
        <div class="max-w-screen-xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
            ...
            <div class="space-y-4">
                ...
                Showcases all my skills and all projects that I have been able to design and develop.
                </p>
                <a href="#" title=""
                class="text-white bg-[#1B263B] justify-center hover:bg-primary-800 inline-flex items-center  focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                role="button">
                View case study
            ...
            <div class="space-y-4">
                ...
                <p class="text-lg font-normal text-gray-500 dark:text-gray-400">
                SwiftTasks helps you plan out your day and helps you become productive by setting tasks to do.
                </p>
                <a href="#" title=""
                class="text-white bg-[#1B263B] justify-center hover:bg-primary-800 inline-flex items-center  focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800"
                role="button">
